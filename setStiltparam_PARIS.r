...
if (is.null(numpix.x)){numpix.x             <- 250}                           # number of pixels in x directions in grid (188 or 47)
if (is.null(numpix.y)){numpix.y             <- 390}                           # number of pixels in y directions in grid (108 or 27)
if (is.null(lon.ll)){lon.ll               <- -15}                             # lower left corner of grid
if (is.null(lat.ll)){lat.ll               <- 33}                              # lower left corner of grid
if (is.null(lon.ur)){lon.ur               <- 35}                              # lower left corner of grid
if (is.null(lat.ur)){lat.ur               <- 72}                              # lower left corner of grid
