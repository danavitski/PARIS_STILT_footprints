...
!
!  $Id: rtsafe.f90,v 1.4 2006-05-29 18:05:42 skoerner Exp $
!
      REAL(KIND(1d0))             :: rtsafe
      REAL(KIND(1d0)), INTENT(IN) :: x1_in,x2_in,xacc,PP,TTEST
...
! CHG: here funcd is THES_T
      INTEGER j
      REAL(KIND(1d0)) :: x1,x2,df,dx,dxold,f,fh,fl,temp,xh,xl
      EXTERNAL THES_T
