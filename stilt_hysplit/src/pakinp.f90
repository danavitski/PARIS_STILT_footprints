...
!   MACHINE:  CRAY
!
! $Id: pakinp.f90,v 1.5 2006-05-29 18:21:30 skoerner Exp $
!
!$$$
      ...
      CHARACTER, INTENT(IN)    :: CVAR(NXY)                 ! packed input of NX*NY
      REAL*8,    INTENT(IN)    :: PREC                      ! precision of packed data
      INTEGER,   INTENT(IN)    :: NEXP                      ! packing scaling exponent
      REAL*8,    INTENT(IN)    :: VAR1                      ! value of array at (1,1)

      INTEGER,   INTENT(INOUT) :: KSUM                      ! rotating checksum
      REAL*8,    INTENT(OUT)   :: RVAR(LX,LY)               ! real data unpacked
