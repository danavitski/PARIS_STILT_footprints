...
parser$add_argument('--lat_ur', type='integer', help='The upper right latitude of the domain')
parser$add_argument('--lon_ll', type='integer', help='The lower left longitude of the domain')
parser$add_argument('--lat_ll', type='integer', help='The lower left latitude of the domain')
