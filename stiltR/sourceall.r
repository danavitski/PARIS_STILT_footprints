...
#---------------------------------------------------------------------------------------------------
sourceall <- function(sparse=TRUE, dense=FALSE) {
    go <- graphics.off
    ...
    source(paste(sourcepath, "setStiltparam.r", sep=""))
    source(paste(sourcepath, "create_times.r", sep=""))
    
    # dkivits 04-10-2023: added these functions
    source(paste(sourcepath, "create_sparse_footprints_coords.r", sep=""))
    source(paste(sourcepath, "Trajecmod_sparse_dense.r", sep=""))
